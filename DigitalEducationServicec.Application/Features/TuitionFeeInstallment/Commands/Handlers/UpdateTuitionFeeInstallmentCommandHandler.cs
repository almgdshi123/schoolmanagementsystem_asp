...
{
    public class UpdateTuitionFeeInstallmentCommandHandler : ResponseHandler,
                                              IRequestHandler<EditTuitionFeeInstallmentCommand, Response<string>>

    {
        ...
        #region Constructors
        public UpdateTuitionFeeInstallmentCommandHandler(ITuitionFeeInstallmentService service,
        ...
        public async Task<Response<string>> Handle(EditTuitionFeeInstallmentCommand request, CancellationToken cancellationToken)
        {
