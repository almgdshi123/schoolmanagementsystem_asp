...
{
    public class DeleteVacationsCommandHandler : ResponseHandler,
                                                      IRequestHandler<DeleteVacationsCommand, Response<string>>

    {
        ...
        #region Constructors
        public DeleteVacationsCommandHandler(IVacationsService service,
        ...
        public async Task<Response<string>> Handle(DeleteVacationsCommand request, CancellationToken cancellationToken)
        {
