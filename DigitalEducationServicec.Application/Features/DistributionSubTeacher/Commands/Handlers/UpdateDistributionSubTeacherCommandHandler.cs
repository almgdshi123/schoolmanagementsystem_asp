...
{
    public class UpdateDistributionSubTeacherCommandHandler : ResponseHandler,
                                       IRequestHandler<EditDistributionSubTeacherCommand, Response<string>>

    {
        ...
        #region Constructors
        public UpdateDistributionSubTeacherCommandHandler(IDistributionSubTeacherService service,
        ...
        public async Task<Response<string>> Handle(EditDistributionSubTeacherCommand request, CancellationToken cancellationToken)
        {
