...
{
    public class UpdateHomeworkCommandHandler : ResponseHandler,
                                       IRequestHandler<EditHomeworkCommand, Response<string>>

    {
        ...
        #region Constructors
        public UpdateHomeworkCommandHandler(IHomeworkService service,
        ...
        public async Task<Response<string>> Handle(EditHomeworkCommand request, CancellationToken cancellationToken)
        {
