...
{
    public class UpdateDocmumentsClassCommandHandler : ResponseHandler,
                                               IRequestHandler<EditDocmunetsClassCommand, Response<string>>

    {
        ...
        #region Constructors
        public UpdateDocmumentsClassCommandHandler(IDocmumentsClassService service,
        ...
        public async Task<Response<string>> Handle(EditDocmunetsClassCommand request, CancellationToken cancellationToken)
        {
