...
{
    public class DeleteDistributionOfBuseStreetCommandHandler : ResponseHandler,
                                             IRequestHandler<DeleteDistributionOfBuseStreetCommand, Response<string>>
    {
        #region Fields
        ...
        #region Constructors
        public DeleteDistributionOfBuseStreetCommandHandler(IDistributionOfBuseStreetService service,
        ...
        public async Task<Response<string>> Handle(DeleteDistributionOfBuseStreetCommand request, CancellationToken cancellationToken)
        {
