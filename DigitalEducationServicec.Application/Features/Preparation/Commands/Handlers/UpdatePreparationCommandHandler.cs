...
{
    public class UpdatePreparationCommandHandler : ResponseHandler,
                                       IRequestHandler<EditPreparationCommand, Response<string>>

    {
        ...
        #region Constructors
        public UpdatePreparationCommandHandler(IPreparationService service,
        ...
        public async Task<Response<string>> Handle(EditPreparationCommand request, CancellationToken cancellationToken)
        {
