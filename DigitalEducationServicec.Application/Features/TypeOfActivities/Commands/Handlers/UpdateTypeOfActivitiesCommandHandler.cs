...
{
    public class UpdateTypeOfActivitiesCommandHandler : ResponseHandler,
                                             IRequestHandler<EditTypeOfActivitiesCommand, Response<string>>
    {
        #region Fields
        ...
        #region Constructors
        public UpdateTypeOfActivitiesCommandHandler(ITypeOfActivitiesService service,
        ...
        public async Task<Response<string>> Handle(EditTypeOfActivitiesCommand request, CancellationToken cancellationToken)
        {
