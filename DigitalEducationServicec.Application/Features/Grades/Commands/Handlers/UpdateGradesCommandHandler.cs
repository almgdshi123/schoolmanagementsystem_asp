...
{
    internal class UpdateGradesCommandHandler : ResponseHandler,
                                       IRequestHandler<EditGradesCommand, Response<string>>

    {
        ...
        #region Constructors
        public UpdateGradesCommandHandler(IGradesService service,
        ...
        public async Task<Response<string>> Handle(EditGradesCommand request, CancellationToken cancellationToken)
        {
