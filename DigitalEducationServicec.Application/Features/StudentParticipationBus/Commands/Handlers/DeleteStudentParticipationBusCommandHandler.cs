...
{
    public class DeleteStudentParticipationBusCommandHandler : ResponseHandler,
                                                      IRequestHandler<DeleteStudentParticipationBusCommand, Response<string>>

    {
        ...
        #region Constructors
        public DeleteStudentParticipationBusCommandHandler(IStudentParticipationBusService service,
        ...
        public async Task<Response<string>> Handle(DeleteStudentParticipationBusCommand request, CancellationToken cancellationToken)
        {
