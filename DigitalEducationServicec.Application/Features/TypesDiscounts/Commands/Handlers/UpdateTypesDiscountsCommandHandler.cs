...
{
    public class UpdateTypesDiscountsCommandHandler : ResponseHandler,
                                            IRequestHandler<EditTypesDiscountsCommand, Response<string>>

    {
        ...
        #region Constructors
        public UpdateTypesDiscountsCommandHandler(ITypesDiscountsService service,
        ...
        public async Task<Response<string>> Handle(EditTypesDiscountsCommand request, CancellationToken cancellationToken)
        {
