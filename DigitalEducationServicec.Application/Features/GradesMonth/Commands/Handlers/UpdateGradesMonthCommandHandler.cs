...
{
    public class UpdateGradesMonthCommandHandler : ResponseHandler,
                                       IRequestHandler<EditGradesMonthCommand, Response<string>>

    {
        ...
        #region Constructors
        public UpdateGradesMonthCommandHandler(IGradesMonthService service,
        ...
        public async Task<Response<string>> Handle(EditGradesMonthCommand request, CancellationToken cancellationToken)
        {
