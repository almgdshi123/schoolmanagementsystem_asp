...
{
    public class UpdateDocmunetStudentCommandHandler : ResponseHandler,
                                           IRequestHandler<EditDocmunetStudentCommand, Response<string>>
    {
        #region Fields
        ...
        #region Constructors
        public UpdateDocmunetStudentCommandHandler(IDocmunetStudentService service,
        ...
        public async Task<Response<string>> Handle(EditDocmunetStudentCommand request, CancellationToken cancellationToken)
        {
