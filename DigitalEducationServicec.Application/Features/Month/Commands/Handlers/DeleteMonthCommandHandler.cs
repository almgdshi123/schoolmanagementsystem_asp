...
{
    public class DeleteMonthCommandHandler : ResponseHandler,
                                       IRequestHandler<DeleteMonthCommand, Response<string>>

    {
        ...
        #region Constructors
        public DeleteMonthCommandHandler(IMonthService service,
        ...
        public async Task<Response<string>> Handle(DeleteMonthCommand request, CancellationToken cancellationToken)
        {
