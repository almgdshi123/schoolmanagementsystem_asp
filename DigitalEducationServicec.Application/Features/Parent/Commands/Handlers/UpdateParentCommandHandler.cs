...
{
    public class UpdateParentCommandHandler : ResponseHandler,
                                       IRequestHandler<EditParentCommand, Response<string>>

    {
        ...
        public async Task<Response<string>> Handle(EditParentCommand request, CancellationToken cancellationToken)
        {
