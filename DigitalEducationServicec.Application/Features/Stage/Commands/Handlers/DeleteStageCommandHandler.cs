...
{
    public class DeleteStageCommandHandler : ResponseHandler,
                                       IRequestHandler<DeleteStageCommand, Response<string>>

    {
        ...
        #region Constructors
        public DeleteStageCommandHandler(IStageService service,
        ...
        public async Task<Response<string>> Handle(DeleteStageCommand request, CancellationToken cancellationToken)
        {
