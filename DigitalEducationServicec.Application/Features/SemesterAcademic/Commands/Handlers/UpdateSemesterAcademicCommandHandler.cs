...
{
    public class UpdateSemesterAcademicCommandHandler : ResponseHandler,
                                       IRequestHandler<EditSemesterAcademicCommand, Response<string>>

    {
        ...
        #region Constructors
        public UpdateSemesterAcademicCommandHandler(ISemesterAcademicService service,
        ...
        public async Task<Response<string>> Handle(EditSemesterAcademicCommand request, CancellationToken cancellationToken)
        {
