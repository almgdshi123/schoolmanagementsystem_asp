...
{
    public class UpdateAppreciationCommandHandler : ResponseHandler,
                                          IRequestHandler<EditAppreciationCommand, Response<string>>

    {
        ...
        #region Constructors
        public UpdateAppreciationCommandHandler(IAppreciationService service,
        ...
        public async Task<Response<string>> Handle(EditAppreciationCommand request, CancellationToken cancellationToken)
        {
