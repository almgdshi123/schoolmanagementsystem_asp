...
{
    public class UpdateStudentActivitieCommandHandler : ResponseHandler,
                                                 IRequestHandler<EditStudentActivitieCommand, Response<string>>

    {
        ...
        #region Constructors
        public UpdateStudentActivitieCommandHandler(IStudentActivitieService service,
        ...
        public async Task<Response<string>> Handle(EditStudentActivitieCommand request, CancellationToken cancellationToken)
        {
