...
{
    public class UpdateParticiStudentActivCommandHandler : ResponseHandler,
                                                     IRequestHandler<EditParticiStudentActivCommand, Response<string>>

    {
        ...
        #region Constructors
        public UpdateParticiStudentActivCommandHandler(IParticiStudentActivService service,
        ...
        public async Task<Response<string>> Handle(EditParticiStudentActivCommand request, CancellationToken cancellationToken)
        {
