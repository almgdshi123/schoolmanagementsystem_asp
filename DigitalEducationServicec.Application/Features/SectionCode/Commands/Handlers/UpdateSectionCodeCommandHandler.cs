...
{
    public class UpdateSectionCodeCommandHandler : ResponseHandler,
                                                  IRequestHandler<EditSectionCodeCommand, Response<string>>
    {
        #region Fields
        ...
        #region Constructors
        public UpdateSectionCodeCommandHandler(ISectionCodeService service,
        ...
        public async Task<Response<string>> Handle(EditSectionCodeCommand request, CancellationToken cancellationToken)
        {
