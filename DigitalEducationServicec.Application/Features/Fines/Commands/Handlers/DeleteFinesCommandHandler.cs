...
{
    public class DeleteFinesCommandHandler : ResponseHandler,
                                                  IRequestHandler<DeleteFinesCommand, Response<string>>
    {
        #region Fields
        ...
        #region Constructors
        public DeleteFinesCommandHandler(IFinesService service,
        ...
        public async Task<Response<string>> Handle(DeleteFinesCommand request, CancellationToken cancellationToken)
        {
