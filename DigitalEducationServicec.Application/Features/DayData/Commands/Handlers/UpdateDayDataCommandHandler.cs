...
{
    public class UpdateDayDataCommandHandler : ResponseHandler,
                                                  IRequestHandler<EditDayDataCommand, Response<string>>
    {
        #region Fields
        ...
        #region Constructors
        public UpdateDayDataCommandHandler(IDayDataService service,
        ...
        public async Task<Response<string>> Handle(EditDayDataCommand request, CancellationToken cancellationToken)
        {
