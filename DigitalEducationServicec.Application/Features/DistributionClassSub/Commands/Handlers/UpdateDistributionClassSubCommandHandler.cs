...
{
    public class UpdateDistributionClassSubCommandHandler : ResponseHandler,
                                       IRequestHandler<EditDistributionClassSubCommand, Response<string>>

    {
        ...
        #region Constructors
        public UpdateDistributionClassSubCommandHandler(IDistributionClassSubService service,
        ...
        public async Task<Response<string>> Handle(EditDistributionClassSubCommand request, CancellationToken cancellationToken)
        {
